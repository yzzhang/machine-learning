    ...
    <View style={styles.container}>
      <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
        ...
        <View style={styles.getStartedContainer}>
          ...
          deep convolutional neural network model MobileNet to classify images on mobile devices.
          It is developed in Expo and React-Native, and thus should work on both iOS and 
          Android mobile devices.
          </Text>

          <View style={[styles.codeHighlightContainer, styles.homeScreenFilename]}>
            <MonoText>Click the image classification tab to start the demo. </MonoText>
          </View>
